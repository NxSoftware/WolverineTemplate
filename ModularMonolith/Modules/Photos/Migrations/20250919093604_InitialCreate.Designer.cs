...
namespace ModularMonolith.Modules.Photos.Migrations
{
    ...
    [Migration("20250919093604_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModularMonolith.Modules.Photos.PhotoModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ModularMonolith.Modules.Photos.UserModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Wolverine.EntityFrameworkCore.Internals.IncomingMessage", b =>
                {
                    ...
                    b.ToTable("wolverine_incoming_envelopes", "WolverinePhotos", t =>
                        {
            ...
            modelBuilder.Entity("Wolverine.EntityFrameworkCore.Internals.OutgoingMessage", b =>
                {
                    ...
                    b.ToTable("wolverine_outgoing_envelopes", "WolverinePhotos", t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("ModularMonolith.Modules.Photos.PhotoModel", b =>
                {
                    b.HasOne("ModularMonolith.Modules.Photos.UserModel", "Photographer")
                        .WithMany("Photos")
